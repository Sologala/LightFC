...
tracker = Tracker(name="lightfc", parameter_name="lightfc_datasets", dataset_name="OTB2015")
...
writer = cv.VideoWriter(
    "output_lightfc-vit.avi", cv.VideoWriter_fourcc(*"XVID"), frame_rate, (frame_width, frame_height)
)
...
while True:
    ...
    cv.putText(
        frame_disp,
        f'{out["score"]}',
        list(map(int, (frame.shape[1] / 2, frame.shape[0] * 0.1))),
        0,
        1,
        (255, 255, 0),
        2,
